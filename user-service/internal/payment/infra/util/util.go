...
// func ContainsPaymentPromotion(PaymentsPromotion []entity.PaymentPromotion, PaymentID int) bool {
// 	for _, PaymentPromotion := range PaymentsPromotion {
// 		if int(PaymentPromotion.PaymentID) == PaymentID {
// 			return true
// 		}
// 	}
// 	return false
