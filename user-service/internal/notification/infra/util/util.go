...
// func ContainsOrderPromotion(OrdersPromotion []entity.OrderPromotion, OrderID int) bool {
// 	for _, OrderPromotion := range OrdersPromotion {
// 		if int(OrderPromotion.OrderID) == OrderID {
// 			return true
// 		}
// 	}
// 	return false
